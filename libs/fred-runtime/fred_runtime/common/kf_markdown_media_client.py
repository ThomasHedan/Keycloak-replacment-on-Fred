...
class KfMarkdownMediaClient(KfBaseClient):
    ...
    def __init__(self, agent: KnowledgeFlowAgentContext):
        """
        Why: reuse authenticated Knowledge Flow access for markdown media fetches.
        How: pass a bound agent context with runtime_context and agent_settings.
        Example:
            >>> client = KfMarkdownMediaClient(agent=agent_ctx)
        """
